// ==================================================================================================================================
// rdpp.sc.sc - Generated by Code_Parser_Sc - Create Recursive Descent Predictive Parser on 2014-05-11 17:06:44 for SuperCollider 3.6
// ==================================================================================================================================
...
SkoarParser {
    ...
    *new {
    ...
    accidentally {
        ...
        desires = [Toke_AccFlat.class, Toke_AccNatural.class, Toke_AccSharp.class];
        if (toker.sees(desires)) {
    ...
    msg_chain_node {
        ...
        desires = [Toke_MsgOp.class, Toke_Soak.class];
        if (toker.sees(desires)) {
    ...
    meter_stmts {
        ...
        desires = [Toke_BassClef.class, Toke_TrebleClef.class, Toke_Symbol.class, Toke_Int.class, Toke_AltoClef.class,
                   Toke_Carrots.class];
        if (toker.sees(desires)) {
    ...
    noaty {
        ...
        desires = [Toke_Symbol.class, Toke_CurNoat.class, Toke_ListS.class];
        if (toker.sees(desires)) {
    ...
    meter_stmt {
        ...
        // meter_stmt -> meteroid
        desires = [Toke_TrebleClef.class, Toke_BassClef.class, Toke_Symbol.class, Toke_AltoClef.class, Toke_Carrots.class];
        if (toker.sees(desires)) {
    ...
    listy_entries {
        ...
        desires = [Toke_String.class, Toke_Caesura.class, Toke_Rep.class, Toke_Float.class, Toke_DubRep.class,
                   Toke_Tuplet.class, Toke_Symbol.class, Toke_OttavaB.class, Toke_QuindicesimaB.class, Toke_CurNoat.class,
                   Toke_DynFP.class, Toke_ListS.class, Toke_AccNatural.class, Toke_PedalUp.class, Toke_Loco.class,
                   Toke_DynPiano.class, Toke_DynForte.class, Toke_AccFlat.class, Toke_DynSFZ.class, Toke_Slur.class,
                   Toke_CondS.class, Toke_AccSharp.class, Toke_VectorNoat.class, Toke_LWing.class, Toke_QuindicesimaA.class,
                   Toke_Int.class, Toke_Portamento.class, Toke_PedalDown.class, Toke_OttavaA.class, Toke_Choard.class];
        if (toker.sees(desires)) {
    ...
    skoar {
        ...
        // skoar -> phrases
        desires = [Toke_Rep.class, Toke_Quavers.class, Toke_DubRep.class, Toke_DaCapo.class, Toke_Symbol.class,
                   Toke_Eighths.class, Toke_Crotchets.class, Toke_QuindicesimaB.class, Toke_DynFP.class, Toke_Slash.class,
                   Toke_AccFlat.class, Toke_Slur.class, Toke_AccSharp.class, Toke_VectorNoat.class, Toke_EOF.class,
                   Toke_OttavaA.class, Toke_Segno.class, Toke_Choard.class, Toke_Fine.class, Toke_String.class,
                   Toke_Comment.class, Toke_Caesura.class, Toke_Coda.class, Toke_Volta.class, Toke_Float.class,
                   Toke_Tuplet.class, Toke_OttavaB.class, Toke_DalSegno.class, Toke_CurNoat.class, Toke_PedalUp.class,
                   Toke_ListS.class, Toke_Loco.class, Toke_AccNatural.class, Toke_DynPiano.class, Toke_DynForte.class,
                   Toke_DynSFZ.class, Toke_CondS.class, Toke_Bars.class, Toke_MeterS.class, Toke_Quarters.class,
                   Toke_LWing.class, Toke_PedalDown.class, Toke_QuindicesimaA.class, Toke_Portamento.class, Toke_Int.class];
        if (toker.sees(desires)) {
            this.phrases(noad);
            ^noad;
        };
    ...
    phrases {
        ...
        desires = [Toke_Rep.class, Toke_Quavers.class, Toke_DubRep.class, Toke_DaCapo.class, Toke_Symbol.class,
                   Toke_Crotchets.class, Toke_Eighths.class, Toke_QuindicesimaB.class, Toke_DynFP.class, Toke_Slash.class,
                   Toke_AccFlat.class, Toke_Slur.class, Toke_AccSharp.class, Toke_VectorNoat.class, Toke_Segno.class,
                   Toke_OttavaA.class, Toke_Choard.class, Toke_Fine.class, Toke_String.class, Toke_Comment.class,
                   Toke_Coda.class, Toke_Caesura.class, Toke_Volta.class, Toke_Float.class, Toke_Tuplet.class,
                   Toke_OttavaB.class, Toke_DalSegno.class, Toke_CurNoat.class, Toke_ListS.class, Toke_AccNatural.class,
                   Toke_Loco.class, Toke_PedalUp.class, Toke_DynPiano.class, Toke_DynForte.class, Toke_DynSFZ.class,
                   Toke_CondS.class, Toke_Bars.class, Toke_MeterS.class, Toke_Quarters.class, Toke_LWing.class,
                   Toke_QuindicesimaA.class, Toke_Int.class, Toke_Portamento.class, Toke_PedalDown.class];
        if (toker.sees(desires)) {
            this.phrasey(noad);
            this.phrases(noad);
            ^noad;
    ...
    nouny {
        ...
        // nouny -> noaty
        desires = [Toke_CurNoat.class, Toke_Symbol.class, Toke_VectorNoat.class, Toke_Choard.class, Toke_ListS.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.noaty(noad));
            ^noad;
        };
        ...
        // nouny -> nouny_literal
        desires = [Toke_Float.class, Toke_Tuplet.class, Toke_String.class, Toke_Caesura.class, Toke_Int.class,
                   Toke_Slur.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_Loco.class, Toke_DynPiano.class, Toke_DynForte.class, Toke_DynSFZ.class, Toke_Rep.class,
                   Toke_DubRep.class, Toke_QuindicesimaA.class, Toke_PedalDown.class, Toke_Portamento.class, Toke_OttavaB.class,
                   Toke_OttavaA.class, Toke_QuindicesimaB.class, Toke_DynFP.class, Toke_PedalUp.class];
        if (toker.sees(desires)) {
    ...
    optional_stmt {
        ...
        // optional_stmt -> stmt
        desires = [Toke_String.class, Toke_Caesura.class, Toke_Rep.class, Toke_Float.class, Toke_DubRep.class,
                   Toke_Tuplet.class, Toke_Symbol.class, Toke_OttavaB.class, Toke_Carrots.class, Toke_QuindicesimaB.class,
                   Toke_DynFP.class, Toke_CurNoat.class, Toke_ListS.class, Toke_AccNatural.class, Toke_PedalUp.class,
                   Toke_Loco.class, Toke_DynPiano.class, Toke_DynForte.class, Toke_AccFlat.class, Toke_DynSFZ.class,
                   Toke_Slur.class, Toke_CondS.class, Toke_AccSharp.class, Toke_VectorNoat.class, Toke_LWing.class,
                   Toke_QuindicesimaA.class, Toke_Int.class, Toke_Portamento.class, Toke_PedalDown.class, Toke_OttavaA.class,
                   Toke_Choard.class];
        if (toker.sees(desires)) {
    ...
    meter_ass_r {
        ...
        desires = [Toke_Quavers.class, Toke_Slash.class, Toke_Crotchets.class, Toke_Eighths.class, Toke_Quarters.class];
        if (toker.sees(desires)) {
        ...
        // meter_ass_r -> dynamic
        desires = [Toke_DynPiano.class, Toke_DynForte.class, Toke_DynFP.class, Toke_DynSFZ.class];
        if (toker.sees(desires)) {
    ...
    meteroid {
        ...
        // meteroid -> clef
        desires = [Toke_TrebleClef.class, Toke_BassClef.class, Toke_AltoClef.class];
        if (toker.sees(desires)) {
    ...
    phrasey {
        ...
        // phrasey -> marker
        desires = [Toke_Coda.class, Toke_Fine.class, Toke_Segno.class, Toke_Volta.class, Toke_Bars.class];
        if (toker.sees(desires)) {
    ...
    musical_keyword {
        ...
        desires = [Toke_Loco.class, Toke_OttavaB.class, Toke_OttavaA.class, Toke_QuindicesimaB.class, Toke_QuindicesimaA.class];
        if (toker.sees(desires)) {
