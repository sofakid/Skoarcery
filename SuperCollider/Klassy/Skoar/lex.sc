// ================================================================================
// lex.sc - Generated by Code_Sc_Lexer on 2014-05-18 15:04:42 for SuperCollider 3.6
// ================================================================================
// --------------
// SkoarException
// --------------
...
SkoarToke {
    ...
    *match_toke {
        ...
        var match;
        if (toke_class.regex.matchRegexp(buf,offs) == false) {
            ^nil;
        };
...
Toke_Whitespace : SkoarToke {
    *burn {
        ...
        var match;
        if ("^\\s*".matchRegexp(buf,offs) == false) {
            ^0;
        };

        match = buf.findRegexp("^\\s*", offs);
        ^match[0][1].size;
    }
