# ===========================================================================
# lex.py - Generated by Code_Py_Lexer on 2015-04-05 12:43:30 for Python 3.3.2
# ===========================================================================
...
class Toke_Int(SkoarToke):
    regex = re.compile(r"(-)?(0|[1-9][0-9]*)(?!Hz|[mv][ab]|\.[0-9]|/)")
...
class Toke_NamedNoat(SkoarToke):
    regex = re.compile(r"(?:_?)(?:[a-eg]|f(?![ac-zA-Z_]))(#*|b*)")
...
class Toke_DynForte(SkoarToke):
    regex = re.compile(r"mf(orte)?|f+orte|ff+")
...
class Toke_Choard(SkoarToke):
    regex = re.compile(r"(D(?![a.])|[ABCEFG])(#|b)?([Mm0-9]|sus|dim)*")
...
class Toke_Segno(SkoarToke):
    regex = re.compile(r",segno`(?:_[a-zA-Z_][a-zA-Z0-9_]*`)*")
