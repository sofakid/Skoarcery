// ==================================================================================================================================
// rdpp.sc.sc - Generated by Code_Parser_Sc - Create Recursive Descent Predictive Parser on 2014-05-11 00:03:50 for SuperCollider 3.6
// ==================================================================================================================================
...
SkoarParser {
    ...
    *new {
    ...
    nouny {
        ...
        // nouny -> noaty
        desires = [Toke_Choard.class, Toke_VectorNoat.class, Toke_CurNoat.class, Toke_Symbol.class, Toke_ListS.class];
        if (toker.sees(desires)) {
        ...
        // nouny -> nouny_literal
        desires = [Toke_Caesura.class, Toke_Tuplet.class, Toke_Float.class, Toke_String.class, Toke_Int.class,
                   Toke_Slur.class];
        if (toker.sees(desires)) {
        ...
        // nouny -> accidentally
        desires = [Toke_AccNatural.class, Toke_AccSharp.class, Toke_AccFlat.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_QuindicesimaA.class, Toke_Portamento.class, Toke_PedalDown.class, Toke_Loco.class, Toke_DubRep.class,
                   Toke_QuindicesimaB.class, Toke_OttavaB.class, Toke_DynSFZ.class, Toke_DynPiano.class, Toke_Rep.class,
                   Toke_OttavaA.class, Toke_DynForte.class, Toke_PedalUp.class, Toke_DynFP.class];
        if (toker.sees(desires)) {
    ...
    phrasey {
        ...
        // phrasey -> marker
        desires = [Toke_Bars.class, Toke_Coda.class, Toke_Fine.class, Toke_Segno.class, Toke_Volta.class];
        if (toker.sees(desires)) {
        ...
        // phrasey -> skoaroid
        desires = [Toke_AccFlat.class, Toke_CondS.class, Toke_AccNatural.class, Toke_Tuplet.class, Toke_Portamento.class,
                   Toke_Loco.class, Toke_DubRep.class, Toke_DynSFZ.class, Toke_Rep.class, Toke_String.class,
                   Toke_OttavaA.class, Toke_DynFP.class, Toke_QuindicesimaA.class, Toke_Float.class, Toke_PedalDown.class,
                   Toke_CurNoat.class, Toke_QuindicesimaB.class, Toke_OttavaB.class, Toke_Caesura.class, Toke_DynPiano.class,
                   Toke_Symbol.class, Toke_PedalUp.class, Toke_Choard.class, Toke_Int.class, Toke_DynForte.class,
                   Toke_Slur.class, Toke_ListS.class, Toke_LWing.class, Toke_AccSharp.class, Toke_VectorNoat.class];
        if (toker.sees(desires)) {
    ...
    meteroid {
        ...
        // meteroid -> clef
        desires = [Toke_AltoClef.class, Toke_TrebleClef.class, Toke_BassClef.class];
        if (toker.sees(desires)) {
    ...
    stmt {
        ...
        desires = [Toke_AccFlat.class, Toke_CondS.class, Toke_AccNatural.class, Toke_Tuplet.class, Toke_Portamento.class,
                   ...
                   Toke_OttavaA.class, Toke_DynFP.class, Toke_QuindicesimaA.class, Toke_Float.class, Toke_PedalDown.class,
                   Toke_CurNoat.class, Toke_QuindicesimaB.class, Toke_OttavaB.class, Toke_Caesura.class, Toke_DynPiano.class,
                   Toke_Carrots.class, Toke_Symbol.class, Toke_PedalUp.class, Toke_Choard.class, Toke_Int.class,
                   Toke_DynForte.class, Toke_Slur.class, Toke_ListS.class, Toke_LWing.class, Toke_AccSharp.class,
                   Toke_VectorNoat.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.optional_carrots(noad));
            noad.add_noad(this.skoaroid(noad));
            noad.add_noad(this.msg_chain_node(noad));
    ...
    meter_stmts {
        ...
        desires = [Toke_Carrots.class, Toke_Symbol.class, Toke_TrebleClef.class, Toke_BassClef.class, Toke_AltoClef.class,
                   Toke_Int.class];
        if (toker.sees(desires)) {
    ...
    skoaroid {
        ...
        desires = [Toke_AccFlat.class, Toke_CondS.class, Toke_AccNatural.class, Toke_Tuplet.class, Toke_Portamento.class,
                   ...
                   Toke_OttavaA.class, Toke_DynFP.class, Toke_QuindicesimaA.class, Toke_Float.class, Toke_PedalDown.class,
                   Toke_CurNoat.class, Toke_QuindicesimaB.class, Toke_OttavaB.class, Toke_Caesura.class, Toke_DynPiano.class,
                   Toke_Symbol.class, Toke_PedalUp.class, Toke_Choard.class, Toke_Int.class, Toke_ListS.class,
                   Toke_Slur.class, Toke_DynForte.class, Toke_LWing.class, Toke_AccSharp.class, Toke_VectorNoat.class];
        if (toker.sees(desires)) {
    ...
    skoar {
        ...
        // skoar -> phrases
        desires = [Toke_CondS.class, Toke_Tuplet.class, Toke_DubRep.class, Toke_DaCapo.class, Toke_Crotchets.class,
                   Toke_Loco.class, Toke_Fine.class, Toke_Comment.class, Toke_String.class, Toke_Volta.class,
                   Toke_DynFP.class, Toke_Coda.class, Toke_Bars.class, Toke_Float.class, Toke_Segno.class,
                   Toke_OttavaB.class, Toke_PedalUp.class, Toke_Choard.class, Toke_Int.class, Toke_Slur.class,
                   Toke_LWing.class, Toke_DalSegno.class, Toke_AccSharp.class, Toke_AccNatural.class, Toke_Portamento.class,
                   Toke_MeterS.class, Toke_Quarters.class, Toke_DynSFZ.class, Toke_Rep.class, Toke_Quavers.class,
                   Toke_OttavaA.class, Toke_EOF.class, Toke_QuindicesimaA.class, Toke_PedalDown.class, Toke_CurNoat.class,
                   Toke_QuindicesimaB.class, Toke_Slash.class, Toke_Caesura.class, Toke_DynPiano.class, Toke_DynForte.class,
                   Toke_Symbol.class, Toke_ListS.class, Toke_Eighths.class, Toke_VectorNoat.class, Toke_AccFlat.class];
        if (toker.sees(desires)) {
            this.phrases(noad);
            ^noad;
        };
    ...
    musical_keyword {
        ...
        desires = [Toke_DynFP.class, Toke_DynPiano.class, Toke_DynForte.class, Toke_DynSFZ.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_QuindicesimaA.class, Toke_Loco.class, Toke_OttavaA.class, Toke_QuindicesimaB.class, Toke_OttavaB.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_PedalDown.class, Toke_PedalUp.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_DubRep.class, Toke_Rep.class, Toke_Portamento.class];
        if (toker.sees(desires)) {
    ...
    noaty {
        ...
        desires = [Toke_CurNoat.class, Toke_Symbol.class, Toke_ListS.class];
        if (toker.sees(desires)) {
    ...
    meter_stmt {
        ...
        // meter_stmt -> meteroid
        desires = [Toke_BassClef.class, Toke_AltoClef.class, Toke_Carrots.class, Toke_TrebleClef.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    phrases {
        ...
        desires = [Toke_CondS.class, Toke_Tuplet.class, Toke_Loco.class, Toke_DaCapo.class, Toke_Crotchets.class,
                   Toke_DubRep.class, Toke_Comment.class, Toke_Fine.class, Toke_String.class, Toke_Volta.class,
                   Toke_DynFP.class, Toke_Coda.class, Toke_Bars.class, Toke_Float.class, Toke_Segno.class,
                   Toke_OttavaB.class, Toke_PedalUp.class, Toke_Choard.class, Toke_Int.class, Toke_Slur.class,
                   Toke_LWing.class, Toke_DalSegno.class, Toke_AccSharp.class, Toke_AccNatural.class, Toke_Portamento.class,
                   Toke_MeterS.class, Toke_Quarters.class, Toke_DynSFZ.class, Toke_Rep.class, Toke_Quavers.class,
                   Toke_OttavaA.class, Toke_QuindicesimaA.class, Toke_PedalDown.class, Toke_CurNoat.class, Toke_QuindicesimaB.class,
                   Toke_Slash.class, Toke_Caesura.class, Toke_DynPiano.class, Toke_Symbol.class, Toke_DynForte.class,
                   Toke_ListS.class, Toke_Eighths.class, Toke_VectorNoat.class, Toke_AccFlat.class];
        if (toker.sees(desires)) {
            this.phrasey(noad);
            this.phrases(noad);
            ^noad;
