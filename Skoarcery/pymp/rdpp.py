# ==================================================================================================================
# rdpp.py - Generated by PyRDPP - Create Recursive Descent Predictive Parser on 2014-04-29 03:01:49 for Python 3.3.2
# ==================================================================================================================
from Skoarcery.pymp.lex import Toke_String, Toke_ZedPlus, Toke_Nosey, Toke_BooleanOp, Toke_VectorNoat, \
    Toke_MeterE, Toke_NoatSharps, Toke_Symbol, Toke_Caesura, Toke_ListS, \
    Toke_MsgOp, Toke_AlSegno, Toke_Portamento, Toke_MeterS, Toke_Choard, \
    Toke_QuindicesimaA, Toke_Rep, Toke_QuindicesimaB, Toke_Fine, Toke_ListE, \
    Toke_AlFine, Toke_Eighths, Toke_Coda, Toke_Bars, Toke_Segno, \
    Toke_Quarters, Toke_Int, Toke_Quavers, Toke_WS, Toke_AccFlat, \
    Toke_NoatFlats, Toke_MeterSig, Toke_CondSep, Toke_AccNatural, Toke_PedalDown, \
    Toke_CondS, Toke_AssOp, Toke_CurNoat, Toke_Volta, Toke_Slur, \
    Toke_DynFP, Toke_Carrots, Toke_Slash, Toke_CondE, Toke_MsgNameWithArgs, \
    Toke_PedalUp, Toke_AltoClef, Toke_Comment, Toke_AccSharp, Toke_Crotchets, \
    Toke_TrebleClef, Toke_EOF, Toke_AlCoda, Toke_DynPiano, Toke_DaCapo, \
    Toke_BassClef, Toke_DynSFZ, Toke_Loco, Toke_DalSegno, Toke_MsgName, \
    Toke_Float, Toke_Tuplet, Toke_DubRep, Toke_OttavaB, Toke_RWing, \
    Toke_OttavaA, Toke_ListSep, Toke_LWing, Toke_DynForte
...
class SkoarParser:
    ...
    def meter_stmts(self):
        ...
        desires = [Toke_TrebleClef, Toke_ZedPlus, Toke_MeterSig, Toke_AltoClef, Toke_BassClef,
                   Toke_Symbol, Toke_Carrots]
    ...
    def boolean(self):
        ...
        desires = [Toke_String, Toke_CondS, Toke_VectorNoat, Toke_CurNoat, Toke_Caesura,
                   Toke_ListS, Toke_Slur, Toke_DynFP, Toke_Portamento, Toke_Choard,
                   Toke_QuindicesimaA, Toke_Rep, Toke_QuindicesimaB, Toke_AccSharp, Toke_Tuplet,
                   Toke_DynPiano, Toke_DubRep, Toke_Loco, Toke_DynSFZ, Toke_Int,
                   Toke_Symbol, Toke_Float, Toke_PedalUp, Toke_AccFlat, Toke_OttavaB,
                   Toke_OttavaA, Toke_AccNatural, Toke_LWing, Toke_PedalDown, Toke_DynForte]
        if self.toker.sees(desires):
    ...
    def skoaroid(self):
        ...
        desires = [Toke_String, Toke_CondS, Toke_VectorNoat, Toke_CurNoat, Toke_Caesura,
                   Toke_ListS, Toke_Slur, Toke_DynFP, Toke_Portamento, Toke_Choard,
                   Toke_QuindicesimaA, Toke_Symbol, Toke_QuindicesimaB, Toke_AccSharp, Toke_Tuplet,
                   Toke_DynPiano, Toke_DubRep, Toke_Loco, Toke_DynSFZ, Toke_Int,
                   Toke_Rep, Toke_Float, Toke_PedalUp, Toke_AccFlat, Toke_OttavaB,
                   Toke_OttavaA, Toke_AccNatural, Toke_LWing, Toke_PedalDown, Toke_DynForte]
        if self.toker.sees(desires):
    ...
    def musical_keyword(self):
        ...
        desires = [Toke_DynSFZ, Toke_DynPiano, Toke_DynFP, Toke_DynForte]
        if self.toker.sees(desires):
        ...
        desires = [Toke_Loco, Toke_OttavaB, Toke_QuindicesimaB, Toke_QuindicesimaA, Toke_OttavaA]
        if self.toker.sees(desires):
        ...
        desires = [Toke_PedalUp, Toke_DubRep, Toke_PedalDown, Toke_Rep, Toke_Portamento]
        if self.toker.sees(desires):
    ...
    def phrasey(self):
        ...
        # phrasey -> markers
        desires = [Toke_Fine, Toke_Segno, Toke_Coda, Toke_Bars]
        if self.toker.sees(desires):
        ...
        # phrasey -> beat
        desires = [Toke_Eighths, Toke_Slash, Toke_Quarters, Toke_Crotchets, Toke_Quavers]
        if self.toker.sees(desires):
    ...
    def phrases(self):
        ...
        desires = [Toke_String, Toke_VectorNoat, Toke_Caesura, Toke_ListS, Toke_Segno,
                   Toke_Portamento, Toke_MeterS, Toke_Choard, Toke_QuindicesimaA, Toke_Quavers,
                   Toke_QuindicesimaB, Toke_Fine, Toke_Eighths, Toke_Coda, Toke_Bars,
                   Toke_DubRep, Toke_Quarters, Toke_Int, Toke_Rep, Toke_PedalUp,
                   Toke_AccFlat, Toke_AccNatural, Toke_PedalDown, Toke_CondS, Toke_CurNoat,
                   Toke_Slur, Toke_DynFP, Toke_Slash, Toke_DynPiano, Toke_AccSharp,
                   Toke_Crotchets, Toke_Comment, Toke_DynForte, Toke_DaCapo, Toke_Loco,
                   Toke_DynSFZ, Toke_Float, Toke_Tuplet, Toke_OttavaB, Toke_OttavaA,
                   Toke_Symbol, Toke_LWing, Toke_DalSegno]
        if self.toker.sees(desires):
    ...
    def skoar(self):
        # skoar -> phrases
        desires = [Toke_String, Toke_VectorNoat, Toke_Caesura, Toke_ListS, Toke_Segno,
                   Toke_Portamento, Toke_MeterS, Toke_Choard, Toke_QuindicesimaA, Toke_Rep,
                   Toke_QuindicesimaB, Toke_Fine, Toke_Eighths, Toke_Coda, Toke_Bars,
                   Toke_DubRep, Toke_Quarters, Toke_Int, Toke_Symbol, Toke_PedalUp,
                   Toke_AccFlat, Toke_AccNatural, Toke_PedalDown, Toke_CondS, Toke_CurNoat,
                   Toke_Slur, Toke_DynFP, Toke_Slash, Toke_Comment, Toke_Quavers,
                   Toke_AccSharp, Toke_Crotchets, Toke_EOF, Toke_DynPiano, Toke_DaCapo,
                   Toke_Loco, Toke_DynSFZ, Toke_Float, Toke_Tuplet, Toke_OttavaB,
                   Toke_OttavaA, Toke_DalSegno, Toke_LWing, Toke_DynForte]
        if self.toker.sees(desires):
    ...
    def nouny(self):
        ...
        # nouny -> noaty
        desires = [Toke_Choard, Toke_CondS, Toke_VectorNoat, Toke_CurNoat, Toke_ListS,
                   Toke_Symbol]
        if self.toker.sees(desires):
        ...
        # nouny -> nouny_literal
        desires = [Toke_Tuplet, Toke_String, Toke_Caesura, Toke_Int, Toke_Slur,
                   Toke_Float]
        if self.toker.sees(desires):
        ...
        desires = [Toke_DynPiano, Toke_DubRep, Toke_Loco, Toke_DynSFZ, Toke_OttavaA,
                   Toke_DynFP, Toke_Portamento, Toke_PedalUp, Toke_OttavaB, Toke_Rep,
                   Toke_QuindicesimaB, Toke_QuindicesimaA, Toke_PedalDown, Toke_DynForte]
        if self.toker.sees(desires):
    ...
    def optional_stmt(self):
        ...
        desires = [Toke_String, Toke_CondS, Toke_VectorNoat, Toke_CurNoat, Toke_Caesura,
                   Toke_ListS, Toke_Slur, Toke_DynFP, Toke_Portamento, Toke_Choard,
                   Toke_QuindicesimaA, Toke_Rep, Toke_QuindicesimaB, Toke_Carrots, Toke_AccSharp,
                   Toke_Tuplet, Toke_DynPiano, Toke_DubRep, Toke_Loco, Toke_DynSFZ,
                   Toke_Int, Toke_Symbol, Toke_Float, Toke_PedalUp, Toke_AccFlat,
                   Toke_OttavaB, Toke_OttavaA, Toke_AccNatural, Toke_LWing, Toke_PedalDown,
                   Toke_DynForte]
        if self.toker.sees(desires):
    ...
    def meter_stmt(self):
        ...
        if self.toker.sees(desires):
            self.print('meter_stmt -> ZedPlus meter_stmt_numbery', end='\n')
            self.toker.burn(Toke_ZedPlus)
            self.print('burning: ZedPlus', end='\n')
            self.meter_stmt_numbery()
            return

        # meter_stmt -> meteroid
        desires = [Toke_TrebleClef, Toke_AltoClef, Toke_BassClef, Toke_Symbol, Toke_Carrots]
        if self.toker.sees(desires):
        ...
        if self.toker.sees(desires):
            self.print('meter_stmt -> MeterSig', end='\n')
            self.toker.burn(Toke_MeterSig)
            self.print('burning: MeterSig', end='\n')
            return

        # meter_stmt -> comment
        desires = []
        if self.toker.sees(desires):
            self.print('meter_stmt -> comment', end='\n')
            self.comment()
            return
    ...
    def stmt(self):
        ...
        desires = [Toke_String, Toke_CondS, Toke_VectorNoat, Toke_CurNoat, Toke_Caesura,
                   Toke_ListS, Toke_Slur, Toke_DynFP, Toke_Carrots, Toke_Choard,
                   Toke_QuindicesimaA, Toke_Rep, Toke_QuindicesimaB, Toke_Portamento, Toke_AccSharp,
                   Toke_Tuplet, Toke_DynPiano, Toke_DubRep, Toke_Loco, Toke_DynSFZ,
                   Toke_Int, Toke_Symbol, Toke_Float, Toke_PedalUp, Toke_AccFlat,
                   Toke_OttavaB, Toke_OttavaA, Toke_AccNatural, Toke_LWing, Toke_PedalDown,
                   Toke_DynForte]
