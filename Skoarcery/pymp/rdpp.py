# ==================================================================================================================
# rdpp.py - Generated by PyRDPP - Create Recursive Descent Predictive Parser on 2014-04-28 22:16:29 for Python 3.3.2
# ==================================================================================================================
from Skoarcery.pymp.lex import Toke_Float, Toke_Nosey, Toke_MeterS, Toke_BooleanOp, Toke_RWing, \
    Toke_Coda, Toke_QuindicesimaA, Toke_QuindicesimaB, Toke_Volta, Toke_MeterE, \
    Toke_CurNoat, Toke_BassClef, Toke_PedalUp, Toke_Int, Toke_CondE, \
    Toke_String, Toke_DubRep, Toke_ListE, Toke_Quavers, Toke_Loco, \
    Toke_NoatSharps, Toke_PedalDown, Toke_ZedPlus, Toke_DynPiano, Toke_Choard, \
    Toke_TrebleClef, Toke_AccFlat, Toke_Tuplet, Toke_ListS, Toke_Quarters, \
    Toke_OttavaB, Toke_Caesura, Toke_CondS, Toke_MsgName, Toke_Carrots, \
    Toke_Portamento, Toke_Bars, Toke_AssOp, Toke_DaCapo, Toke_AlFine, \
    Toke_DalSegno, Toke_Segno, Toke_MsgNameWithArgs, Toke_AccSharp, Toke_WS, \
    Toke_CondSep, Toke_Slur, Toke_Eighths, Toke_AlSegno, Toke_VectorNoat, \
    Toke_Slash, Toke_DynFP, Toke_Rep, Toke_MeterSig, Toke_LWing, \
    Toke_AltoClef, Toke_Crotchets, Toke_DynForte, Toke_MsgOp, Toke_ListSep, \
    Toke_DynSFZ, Toke_NoatFlats, Toke_AlCoda, Toke_OttavaA, Toke_EOF, \
    Toke_Fine, Toke_Symbol, Toke_AccNatural
...
class SkoarParser:
    ...
    def skoar(self):
        # skoar -> phrases
        desires = [Toke_Float, Toke_Loco, Toke_MeterS, Toke_Slash, Toke_Coda,
                   Toke_QuindicesimaA, Toke_QuindicesimaB, Toke_CurNoat, Toke_PedalUp, Toke_Int,
                   Toke_String, Toke_DubRep, Toke_Slur, Toke_DynPiano, Toke_Choard,
                   Toke_AccFlat, Toke_Tuplet, Toke_DaCapo, Toke_Quarters, Toke_Caesura,
                   Toke_CondS, Toke_Portamento, Toke_PedalDown, Toke_ListS, Toke_DalSegno,
                   Toke_Segno, Toke_AccSharp, Toke_DynFP, Toke_Quavers, Toke_Eighths,
                   Toke_VectorNoat, Toke_Rep, Toke_LWing, Toke_Crotchets, Toke_DynForte,
                   Toke_Bars, Toke_DynSFZ, Toke_OttavaB, Toke_OttavaA, Toke_EOF,
                   Toke_Fine, Toke_Symbol, Toke_AccNatural]
    ...
    def listy_entries(self):
        ...
        desires = [Toke_Float, Toke_Loco, Toke_DynPiano, Toke_CondS, Toke_PedalDown,
                   Toke_QuindicesimaA, Toke_QuindicesimaB, Toke_CurNoat, Toke_PedalUp, Toke_Int,
                   Toke_String, Toke_DubRep, Toke_Choard, Toke_AccFlat, Toke_Tuplet,
                   Toke_ListS, Toke_Caesura, Toke_Portamento, Toke_AccSharp, Toke_DynFP,
                   Toke_Slur, Toke_VectorNoat, Toke_Rep, Toke_LWing, Toke_DynForte,
                   Toke_DynSFZ, Toke_OttavaB, Toke_OttavaA, Toke_Symbol, Toke_AccNatural]
        if self.toker.sees(desires):
            self.skoaroid()
    ...
    def listy_suffix(self):
        ...
        desires = [Toke_Float, Toke_Loco, Toke_DynPiano, Toke_CondS, Toke_PedalDown,
                   Toke_QuindicesimaA, Toke_QuindicesimaB, Toke_CurNoat, Toke_PedalUp, Toke_Int,
                   Toke_String, Toke_DubRep, Toke_Choard, Toke_Portamento, Toke_Tuplet,
                   Toke_ListS, Toke_Caesura, Toke_AccFlat, Toke_AccSharp, Toke_DynFP,
                   Toke_Slur, Toke_VectorNoat, Toke_Rep, Toke_LWing, Toke_DynForte,
                   Toke_DynSFZ, Toke_OttavaB, Toke_OttavaA, Toke_Symbol, Toke_AccNatural]
        if self.toker.sees(desires):
            self.listy_entries()
    ...
    def optional_stmt(self):
        ...
        desires = [Toke_Float, Toke_Loco, Toke_DynPiano, Toke_CondS, Toke_PedalDown,
                   Toke_QuindicesimaA, Toke_QuindicesimaB, Toke_CurNoat, Toke_PedalUp, Toke_Int,
                   Toke_String, Toke_DubRep, Toke_Choard, Toke_Portamento, Toke_Tuplet,
                   Toke_ListS, Toke_Caesura, Toke_Carrots, Toke_AccFlat, Toke_AccSharp,
                   Toke_DynFP, Toke_Slur, Toke_VectorNoat, Toke_Rep, Toke_LWing,
                   Toke_DynForte, Toke_DynSFZ, Toke_OttavaB, Toke_OttavaA, Toke_Symbol,
                   Toke_AccNatural]
        if self.toker.sees(desires):
            self.stmt()
            return
    ...
    def meter_stmts(self):
        ...
        desires = [Toke_Carrots, Toke_ZedPlus, Toke_BassClef, Toke_TrebleClef, Toke_MeterSig,
                   Toke_AltoClef, Toke_Symbol]
        if self.toker.sees(desires):
            self.meter_stmt()
            self.meter_stmts()
            return
    ...
    def phrases(self):
        ...
        desires = [Toke_Float, Toke_Loco, Toke_MeterS, Toke_Slash, Toke_Coda,
                   Toke_QuindicesimaA, Toke_QuindicesimaB, Toke_CurNoat, Toke_PedalUp, Toke_Int,
                   Toke_String, Toke_DubRep, Toke_Slur, Toke_DynPiano, Toke_Choard,
                   Toke_Portamento, Toke_Tuplet, Toke_DaCapo, Toke_Quarters, Toke_Caesura,
                   Toke_CondS, Toke_AccFlat, Toke_PedalDown, Toke_ListS, Toke_DalSegno,
                   Toke_Segno, Toke_AccSharp, Toke_DynFP, Toke_Quavers, Toke_Eighths,
                   Toke_VectorNoat, Toke_Rep, Toke_LWing, Toke_Crotchets, Toke_DynForte,
                   Toke_Bars, Toke_DynSFZ, Toke_OttavaB, Toke_OttavaA, Toke_Fine,
                   Toke_Symbol, Toke_AccNatural]
        if self.toker.sees(desires):
            self.phrasey()
            self.phrases()
            return
    ...
    def musical_keyword(self):
        ...
        desires = [Toke_Loco, Toke_QuindicesimaA, Toke_QuindicesimaB, Toke_OttavaB, Toke_OttavaA]
        if self.toker.sees(desires):
            self.ottavas()
            return

        # musical_keyword -> musical_keyword_misc
        desires = [Toke_Rep, Toke_Portamento, Toke_PedalDown, Toke_PedalUp, Toke_DubRep]
        if self.toker.sees(desires):
    ...
    def meter_ass_r(self):
        ...
        # meter_ass_r -> beat
        desires = [Toke_Crotchets, Toke_Quarters, Toke_Slash, Toke_Quavers, Toke_Eighths]
        if self.toker.sees(desires):
            self.beat()
            return
    ...
    def meter_stmt(self):
        ...
        # meter_stmt -> meteroid
        desires = [Toke_Carrots, Toke_BassClef, Toke_TrebleClef, Toke_AltoClef, Toke_Symbol]
        if self.toker.sees(desires):
            self.meteroid()
            return
    ...
    def nouny(self):
        ...
        # nouny -> noaty
        desires = [Toke_CondS, Toke_Choard, Toke_CurNoat, Toke_ListS, Toke_Symbol,
                   Toke_VectorNoat]
        if self.toker.sees(desires):
            self.noaty()
            return
        ...
        # nouny -> nouny_literal
        desires = [Toke_Caesura, Toke_Float, Toke_Tuplet, Toke_Int, Toke_Slur,
                   Toke_String]
        if self.toker.sees(desires):
            self.nouny_literal()
            return
        ...
        desires = [Toke_Loco, Toke_DynPiano, Toke_Portamento, Toke_PedalDown, Toke_QuindicesimaA,
                   Toke_QuindicesimaB, Toke_PedalUp, Toke_DynFP, Toke_DubRep, Toke_Rep,
                   Toke_DynForte, Toke_DynSFZ, Toke_OttavaB, Toke_OttavaA]
        if self.toker.sees(desires):
    ...
    def phrasey(self):
        # phrasey -> markers
        desires = [Toke_Coda, Toke_Bars, Toke_Segno, Toke_Fine]
        if self.toker.sees(desires):
            self.markers()
            return
