// ==================================================================================================================================
// rdpp.sc.sc - Generated by Code_Parser_Sc - Create Recursive Descent Predictive Parser on 2014-05-11 10:37:36 for SuperCollider 3.6
// ==================================================================================================================================
...
SkoarParser {
    ...
    *new {
    ...
    nouny {
        ...
        // nouny -> noaty
        desires = [Toke_VectorNoat.class, Toke_Symbol.class, Toke_Choard.class, Toke_CurNoat.class, Toke_ListS.class];
        if (toker.sees(desires)) {
        ...
        // nouny -> nouny_literal
        desires = [Toke_Caesura.class, Toke_String.class, Toke_Slur.class, Toke_Int.class, Toke_Float.class,
                   Toke_Tuplet.class];
        if (toker.sees(desires)) {
        ...
        // nouny -> accidentally
        desires = [Toke_AccSharp.class, Toke_AccFlat.class, Toke_AccNatural.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_DubRep.class, Toke_QuindicesimaB.class, Toke_Portamento.class, Toke_Rep.class, Toke_OttavaA.class,
                   Toke_QuindicesimaA.class, Toke_PedalUp.class, Toke_PedalDown.class, Toke_DynSFZ.class, Toke_DynForte.class,
                   Toke_DynPiano.class, Toke_Loco.class, Toke_OttavaB.class, Toke_DynFP.class];
        if (toker.sees(desires)) {
    ...
    boolean {
        ...
        desires = [Toke_Caesura.class, Toke_DubRep.class, Toke_Rep.class, Toke_OttavaA.class, Toke_Float.class,
                   Toke_Choard.class, Toke_CurNoat.class, Toke_Tuplet.class, Toke_VectorNoat.class, Toke_AccNatural.class,
                   Toke_PedalDown.class, Toke_DynFP.class, Toke_QuindicesimaB.class, Toke_AccSharp.class, Toke_Portamento.class,
                   Toke_Symbol.class, Toke_QuindicesimaA.class, Toke_CondS.class, Toke_PedalUp.class, Toke_LWing.class,
                   Toke_String.class, Toke_ListS.class, Toke_DynSFZ.class, Toke_Int.class, Toke_Slur.class,
                   Toke_AccFlat.class, Toke_DynForte.class, Toke_Loco.class, Toke_OttavaB.class, Toke_DynPiano.class];
        if (toker.sees(desires)) {
    ...
    meter_ass_r {
        ...
        desires = [Toke_Quarters.class, Toke_Eighths.class, Toke_Slash.class, Toke_Quavers.class, Toke_Crotchets.class];
        if (toker.sees(desires)) {
        ...
        // meter_ass_r -> dynamic
        desires = [Toke_DynSFZ.class, Toke_DynForte.class, Toke_DynPiano.class, Toke_DynFP.class];
        if (toker.sees(desires)) {
    ...
    skoar {
        ...
        // skoar -> phrases
        desires = [Toke_DubRep.class, Toke_Caesura.class, Toke_Crotchets.class, Toke_Float.class, Toke_Choard.class,
                   Toke_Fine.class, Toke_Tuplet.class, Toke_EOF.class, Toke_PedalDown.class, Toke_Comment.class,
                   Toke_DynFP.class, Toke_QuindicesimaB.class, Toke_AccSharp.class, Toke_Eighths.class, Toke_Portamento.class,
                   Toke_Quavers.class, Toke_DalSegno.class, Toke_PedalUp.class, Toke_QuindicesimaA.class, Toke_CondS.class,
                   Toke_LWing.class, Toke_String.class, Toke_Quarters.class, Toke_Int.class, Toke_DynSFZ.class,
                   Toke_MeterS.class, Toke_OttavaB.class, Toke_Volta.class, Toke_Loco.class, Toke_Bars.class,
                   Toke_Rep.class, Toke_OttavaA.class, Toke_Segno.class, Toke_Coda.class, Toke_CurNoat.class,
                   Toke_VectorNoat.class, Toke_AccNatural.class, Toke_Slash.class, Toke_Symbol.class, Toke_ListS.class,
                   Toke_DaCapo.class, Toke_Slur.class, Toke_AccFlat.class, Toke_DynPiano.class, Toke_DynForte.class];
        if (toker.sees(desires)) {
            this.phrases(noad);
            ^noad;
        };
    ...
    meter_stmt {
        ...
        // meter_stmt -> meteroid
        desires = [Toke_BassClef.class, Toke_Symbol.class, Toke_AltoClef.class, Toke_TrebleClef.class, Toke_Carrots.class];
        if (toker.sees(desires)) {
    ...
    musical_keyword {
        ...
        desires = [Toke_OttavaA.class, Toke_QuindicesimaA.class, Toke_QuindicesimaB.class, Toke_Loco.class, Toke_OttavaB.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_DubRep.class, Toke_Portamento.class, Toke_Rep.class];
        if (toker.sees(desires)) {
    ...
    optional_stmt {
        ...
        desires = [Toke_Caesura.class, Toke_DubRep.class, Toke_Rep.class, Toke_OttavaA.class, Toke_Float.class,
                   Toke_Choard.class, Toke_CurNoat.class, Toke_Tuplet.class, Toke_VectorNoat.class, Toke_AccNatural.class,
                   Toke_PedalDown.class, Toke_DynFP.class, Toke_QuindicesimaB.class, Toke_Carrots.class, Toke_AccSharp.class,
                   Toke_Portamento.class, Toke_Symbol.class, Toke_QuindicesimaA.class, Toke_CondS.class, Toke_PedalUp.class,
                   Toke_LWing.class, Toke_String.class, Toke_ListS.class, Toke_DynSFZ.class, Toke_Int.class,
                   Toke_Slur.class, Toke_AccFlat.class, Toke_DynForte.class, Toke_OttavaB.class, Toke_Loco.class,
                   Toke_DynPiano.class];
        if (toker.sees(desires)) {
    ...
    stmt {
        ...
        desires = [Toke_Caesura.class, Toke_DubRep.class, Toke_Rep.class, Toke_OttavaA.class, Toke_Float.class,
                   ...
                   Toke_Portamento.class, Toke_Symbol.class, Toke_QuindicesimaA.class, Toke_CondS.class, Toke_PedalUp.class,
                   Toke_LWing.class, Toke_String.class, Toke_ListS.class, Toke_DynSFZ.class, Toke_Int.class,
                   Toke_Slur.class, Toke_AccFlat.class, Toke_DynForte.class, Toke_Loco.class, Toke_OttavaB.class,
                   Toke_DynPiano.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.optional_carrots(noad));
            noad.add_noad(this.skoaroid(noad));
    ...
    meter_stmts {
        ...
        desires = [Toke_Symbol.class, Toke_AltoClef.class, Toke_TrebleClef.class, Toke_Int.class, Toke_BassClef.class,
                   Toke_Carrots.class];
        if (toker.sees(desires)) {
    ...
    phrasey {
        ...
        // phrasey -> marker
        desires = [Toke_Segno.class, Toke_Bars.class, Toke_Coda.class, Toke_Fine.class, Toke_Volta.class];
        if (toker.sees(desires)) {
    ...
    phrases {
        ...
        desires = [Toke_Caesura.class, Toke_DubRep.class, Toke_Crotchets.class, Toke_Float.class, Toke_Choard.class,
                   Toke_Fine.class, Toke_Tuplet.class, Toke_PedalDown.class, Toke_Comment.class, Toke_DynFP.class,
                   Toke_QuindicesimaB.class, Toke_AccSharp.class, Toke_Eighths.class, Toke_Portamento.class, Toke_Quavers.class,
                   Toke_DalSegno.class, Toke_QuindicesimaA.class, Toke_CondS.class, Toke_PedalUp.class, Toke_LWing.class,
                   Toke_String.class, Toke_Quarters.class, Toke_MeterS.class, Toke_Int.class, Toke_DynSFZ.class,
                   Toke_Loco.class, Toke_Volta.class, Toke_OttavaB.class, Toke_Bars.class, Toke_Rep.class,
                   Toke_OttavaA.class, Toke_Segno.class, Toke_Coda.class, Toke_CurNoat.class, Toke_VectorNoat.class,
                   Toke_AccNatural.class, Toke_Slash.class, Toke_Symbol.class, Toke_ListS.class, Toke_DaCapo.class,
                   Toke_Slur.class, Toke_AccFlat.class, Toke_DynForte.class, Toke_DynPiano.class];
        if (toker.sees(desires)) {
            this.phrasey(noad);
            this.phrases(noad);
            ^noad;
