// ==================================================================================================================================
// rdpp.sc.sc - Generated by Code_Parser_Sc - Create Recursive Descent Predictive Parser on 2014-05-12 05:17:58 for SuperCollider 3.6
// ==================================================================================================================================
...
SkoarParser {
    ...
    *new {
    ...
    skoaroid {
        ...
        desires = [Toke_PedalUp.class, Toke_Rep.class, Toke_DynPiano.class, Toke_OttavaB.class, Toke_Tuplet.class,
                   Toke_CondS.class, Toke_LWing.class, Toke_Choard.class, Toke_QuindicesimaB.class, Toke_Float.class,
                   Toke_DynFP.class, Toke_DubRep.class, Toke_Caesura.class, Toke_PedalDown.class, Toke_AccFlat.class,
                   Toke_DynSFZ.class, Toke_String.class, Toke_CurNoat.class, Toke_AccNatural.class, Toke_DynForte.class,
                   Toke_Portamento.class, Toke_AccSharp.class, Toke_Int.class, Toke_ListS.class, Toke_Loco.class,
                   Toke_Slur.class, Toke_QuindicesimaA.class, Toke_OttavaA.class, Toke_VectorNoat.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    meter_ass_r {
        ...
        desires = [Toke_Crotchets.class, Toke_Quarters.class, Toke_Slash.class, Toke_Eighths.class, Toke_Quavers.class];
        if (toker.sees(desires)) {
        ...
        // meter_ass_r -> dynamic
        desires = [Toke_DynFP.class, Toke_DynForte.class, Toke_DynSFZ.class, Toke_DynPiano.class];
        if (toker.sees(desires)) {
    ...
    phrases {
        ...
        desires = [Toke_CondS.class, Toke_Eighths.class, Toke_LWing.class, Toke_Bars.class, Toke_DynFP.class,
                   Toke_PedalDown.class, Toke_AccFlat.class, Toke_Fine.class, Toke_DalSegno.class, Toke_Comment.class,
                   Toke_AccSharp.class, Toke_Volta.class, Toke_Int.class, Toke_ListS.class, Toke_Loco.class,
                   Toke_MeterS.class, Toke_Slur.class, Toke_VectorNoat.class, Toke_Symbol.class, Toke_Coda.class,
                   Toke_PedalUp.class, Toke_Rep.class, Toke_DynPiano.class, Toke_OttavaB.class, Toke_Tuplet.class,
                   Toke_Choard.class, Toke_QuindicesimaB.class, Toke_Float.class, Toke_DubRep.class, Toke_Caesura.class,
                   Toke_Quavers.class, Toke_Quarters.class, Toke_DynSFZ.class, Toke_String.class, Toke_Crotchets.class,
                   Toke_CurNoat.class, Toke_Slash.class, Toke_AccNatural.class, Toke_DynForte.class, Toke_DaCapo.class,
                   Toke_Segno.class, Toke_Portamento.class, Toke_QuindicesimaA.class, Toke_OttavaA.class];
        if (toker.sees(desires)) {
            this.phrasey(noad);
            this.phrases(noad);
            ^noad;
    ...
    skoar {
        ...
        // skoar -> phrases
        desires = [Toke_CondS.class, Toke_LWing.class, Toke_Eighths.class, Toke_Bars.class, Toke_DynFP.class,
                   Toke_PedalDown.class, Toke_AccFlat.class, Toke_Fine.class, Toke_DalSegno.class, Toke_Comment.class,
                   Toke_EOF.class, Toke_AccSharp.class, Toke_Volta.class, Toke_Int.class, Toke_ListS.class,
                   Toke_Loco.class, Toke_MeterS.class, Toke_Slur.class, Toke_VectorNoat.class, Toke_Coda.class,
                   Toke_Symbol.class, Toke_PedalUp.class, Toke_Rep.class, Toke_DynPiano.class, Toke_OttavaB.class,
                   Toke_Tuplet.class, Toke_Choard.class, Toke_QuindicesimaB.class, Toke_Float.class, Toke_DubRep.class,
                   Toke_Caesura.class, Toke_Quavers.class, Toke_Quarters.class, Toke_DynSFZ.class, Toke_String.class,
                   Toke_Crotchets.class, Toke_AccNatural.class, Toke_CurNoat.class, Toke_Slash.class, Toke_DynForte.class,
                   Toke_DaCapo.class, Toke_Segno.class, Toke_Portamento.class, Toke_QuindicesimaA.class, Toke_OttavaA.class];
        if (toker.sees(desires)) {
            this.phrases(noad);
            ^noad;
        };
    ...
    meter_stmts {
        ...
        desires = [Toke_Int.class, Toke_AltoClef.class, Toke_Carrots.class, Toke_TrebleClef.class, Toke_BassClef.class,
                   Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    musical_keyword {
        ...
        desires = [Toke_OttavaB.class, Toke_QuindicesimaA.class, Toke_Loco.class, Toke_OttavaA.class, Toke_QuindicesimaB.class];
        if (toker.sees(desires)) {
    ...
    stmt {
        ...
        desires = [Toke_PedalUp.class, Toke_Rep.class, Toke_DynPiano.class, Toke_OttavaB.class, Toke_Tuplet.class,
                   Toke_CondS.class, Toke_LWing.class, Toke_Choard.class, Toke_QuindicesimaB.class, Toke_Float.class,
                   Toke_DynFP.class, Toke_Carrots.class, Toke_DubRep.class, Toke_Caesura.class, Toke_PedalDown.class,
                   Toke_AccFlat.class, Toke_DynSFZ.class, Toke_String.class, Toke_CurNoat.class, Toke_AccNatural.class,
                   Toke_DynForte.class, Toke_Portamento.class, Toke_AccSharp.class, Toke_Int.class, Toke_ListS.class,
                   Toke_Loco.class, Toke_Slur.class, Toke_QuindicesimaA.class, Toke_OttavaA.class, Toke_VectorNoat.class,
                   Toke_Symbol.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.optional_carrots(noad));
            noad.add_noad(this.skoaroid(noad));
    ...
    meter_stmt {
        ...
        // meter_stmt -> meteroid
        desires = [Toke_TrebleClef.class, Toke_Carrots.class, Toke_AltoClef.class, Toke_BassClef.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    phrasey {
        ...
        // phrasey -> marker
        desires = [Toke_Bars.class, Toke_Fine.class, Toke_Volta.class, Toke_Segno.class, Toke_Coda.class];
        if (toker.sees(desires)) {
    ...
    nouny {
        ...
        // nouny -> noaty
        desires = [Toke_CurNoat.class, Toke_ListS.class, Toke_Choard.class, Toke_VectorNoat.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.noaty(noad));
            ^noad;
        };
        ...
        // nouny -> nouny_literal
        desires = [Toke_Int.class, Toke_Caesura.class, Toke_Slur.class, Toke_Tuplet.class, Toke_Float.class,
                   Toke_String.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_PedalUp.class, Toke_Rep.class, Toke_DynForte.class, Toke_DynPiano.class, Toke_OttavaB.class,
                   Toke_QuindicesimaB.class, Toke_Portamento.class, Toke_DynFP.class, Toke_Loco.class, Toke_DubRep.class,
                   Toke_PedalDown.class, Toke_QuindicesimaA.class, Toke_OttavaA.class, Toke_DynSFZ.class];
        if (toker.sees(desires)) {
