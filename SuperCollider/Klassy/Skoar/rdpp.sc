// ==================================================================================================================================
// rdpp.sc.sc - Generated by Code_Parser_Sc - Create Recursive Descent Predictive Parser on 2014-05-17 01:00:29 for SuperCollider 3.6
// ==================================================================================================================================
...
SkoarParser {
    ...
    *new {
    ...
    optional_stmt {
        ...
        // optional_stmt -> stmt
        desires = [Toke_QuindicesimaA.class, Toke_Loco.class, Toke_Caesura.class, Toke_QuindicesimaB.class, Toke_LWing.class,
                   Toke_DynPiano.class, Toke_Rep.class, Toke_String.class, Toke_Int.class, Toke_AccNatural.class,
                   Toke_OttavaB.class, Toke_Choard.class, Toke_PedalDown.class, Toke_PedalUp.class, Toke_ListS.class,
                   Toke_CurNoat.class, Toke_Float.class, Toke_OttavaA.class, Toke_AccSharp.class, Toke_DynForte.class,
                   Toke_DubRep.class, Toke_Tuplet.class, Toke_Slur.class, Toke_DynSFZ.class, Toke_Carrots.class,
                   Toke_Symbol.class, Toke_Portamento.class, Toke_DynFP.class, Toke_VectorNoat.class, Toke_AccFlat.class,
                   Toke_CondS.class];
    ...
    meter_ass_r {
        ...
        desires = [Toke_Quarters.class, Toke_Slash.class, Toke_Crotchets.class, Toke_Eighths.class, Toke_Quavers.class];
        if (toker.sees(desires)) {
        ...
        // meter_ass_r -> dynamic
        desires = [Toke_DynSFZ.class, Toke_DynForte.class, Toke_DynFP.class, Toke_DynPiano.class];
        if (toker.sees(desires)) {
    ...
    meter_stmt {
        ...
        // meter_stmt -> meteroid
        desires = [Toke_Carrots.class, Toke_Symbol.class, Toke_TrebleClef.class, Toke_AltoClef.class, Toke_BassClef.class];
        if (toker.sees(desires)) {
    ...
    meter_stmts {
        ...
        desires = [Toke_Int.class, Toke_TrebleClef.class, Toke_Carrots.class, Toke_Symbol.class, Toke_AltoClef.class,
                   Toke_BassClef.class];
        if (toker.sees(desires)) {
    ...
    skoaroid {
        ...
        desires = [Toke_QuindicesimaA.class, Toke_Loco.class, Toke_Caesura.class, Toke_QuindicesimaB.class, Toke_LWing.class,
                   ...
                   Toke_OttavaB.class, Toke_Choard.class, Toke_PedalDown.class, Toke_PedalUp.class, Toke_ListS.class,
                   Toke_CurNoat.class, Toke_Float.class, Toke_OttavaA.class, Toke_AccSharp.class, Toke_DynForte.class,
                   Toke_DubRep.class, Toke_Tuplet.class, Toke_Slur.class, Toke_DynSFZ.class, Toke_Symbol.class,
                   Toke_Portamento.class, Toke_DynFP.class, Toke_VectorNoat.class, Toke_AccFlat.class, Toke_CondS.class];
        if (toker.sees(desires)) {
    ...
    stmt {
        ...
        desires = [Toke_QuindicesimaA.class, Toke_Loco.class, Toke_Caesura.class, Toke_QuindicesimaB.class, Toke_LWing.class,
                   Toke_DynPiano.class, Toke_Rep.class, Toke_String.class, Toke_Int.class, Toke_AccNatural.class,
                   Toke_OttavaB.class, Toke_Choard.class, Toke_PedalDown.class, Toke_PedalUp.class, Toke_ListS.class,
                   Toke_CurNoat.class, Toke_Float.class, Toke_DynForte.class, Toke_AccSharp.class, Toke_OttavaA.class,
                   Toke_DubRep.class, Toke_Tuplet.class, Toke_Slur.class, Toke_Carrots.class, Toke_DynSFZ.class,
                   Toke_Symbol.class, Toke_Portamento.class, Toke_DynFP.class, Toke_VectorNoat.class, Toke_AccFlat.class,
                   Toke_CondS.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.optional_carrots(noad));
    ...
    nouny {
        ...
        // nouny -> noaty
        desires = [Toke_VectorNoat.class, Toke_Symbol.class, Toke_Choard.class, Toke_ListS.class, Toke_CurNoat.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.noaty(noad));
            ^noad;
        };
        ...
        // nouny -> nouny_literal
        desires = [Toke_String.class, Toke_Int.class, Toke_Tuplet.class, Toke_Caesura.class, Toke_Slur.class,
                   Toke_Float.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_OttavaA.class, Toke_DubRep.class, Toke_QuindicesimaA.class, Toke_Loco.class, Toke_DynSFZ.class,
                   Toke_QuindicesimaB.class, Toke_Portamento.class, Toke_DynFP.class, Toke_DynPiano.class, Toke_OttavaB.class,
                   Toke_Rep.class, Toke_PedalDown.class, Toke_PedalUp.class, Toke_DynForte.class];
        if (toker.sees(desires)) {
    ...
    phrases {
        ...
        desires = [Toke_QuindicesimaA.class, Toke_Loco.class, Toke_QuindicesimaB.class, Toke_DynPiano.class, Toke_String.class,
                   Toke_Int.class, Toke_PedalDown.class, Toke_PedalUp.class, Toke_CurNoat.class, Toke_Tuplet.class,
                   Toke_DynSFZ.class, Toke_Portamento.class, Toke_DynFP.class, Toke_VectorNoat.class, Toke_Caesura.class,
                   Toke_LWing.class, Toke_Volta.class, Toke_Rep.class, Toke_AccNatural.class, Toke_Coda.class,
                   Toke_OttavaB.class, Toke_Slash.class, Toke_Crotchets.class, Toke_Eighths.class, Toke_Quavers.class,
                   Toke_MeterS.class, Toke_Choard.class, Toke_ListS.class, Toke_Float.class, Toke_Segno.class,
                   Toke_OttavaA.class, Toke_AccSharp.class, Toke_DynForte.class, Toke_Quarters.class, Toke_DubRep.class,
                   Toke_Bars.class, Toke_Slur.class, Toke_Symbol.class, Toke_Comment.class, Toke_AccFlat.class,
                   Toke_DalSegno.class, Toke_Fine.class, Toke_DaCapo.class, Toke_CondS.class];
        if (toker.sees(desires)) {
            this.phrasey(noad);
            this.phrases(noad);
            ^noad;
    ...
    phrasey {
        ...
        // phrasey -> marker
        desires = [Toke_Coda.class, Toke_Fine.class, Toke_Segno.class, Toke_Bars.class, Toke_Volta.class];
        if (toker.sees(desires)) {
    ...
    musical_keyword {
        ...
        desires = [Toke_OttavaB.class, Toke_QuindicesimaB.class, Toke_QuindicesimaA.class, Toke_Loco.class, Toke_OttavaA.class];
        if (toker.sees(desires)) {
    ...
    skoar {
        ...
        // skoar -> phrases
        desires = [Toke_EOF.class, Toke_QuindicesimaA.class, Toke_Loco.class, Toke_QuindicesimaB.class, Toke_DynPiano.class,
                   Toke_String.class, Toke_Int.class, Toke_PedalDown.class, Toke_PedalUp.class, Toke_CurNoat.class,
                   Toke_Tuplet.class, Toke_DynSFZ.class, Toke_Portamento.class, Toke_DynFP.class, Toke_VectorNoat.class,
                   Toke_Caesura.class, Toke_LWing.class, Toke_Volta.class, Toke_Rep.class, Toke_AccNatural.class,
                   Toke_Coda.class, Toke_OttavaB.class, Toke_Slash.class, Toke_Crotchets.class, Toke_Eighths.class,
                   Toke_Choard.class, Toke_MeterS.class, Toke_Quavers.class, Toke_ListS.class, Toke_Float.class,
                   Toke_Segno.class, Toke_DynForte.class, Toke_OttavaA.class, Toke_AccSharp.class, Toke_DubRep.class,
                   Toke_Quarters.class, Toke_Bars.class, Toke_Slur.class, Toke_Symbol.class, Toke_Comment.class,
                   Toke_AccFlat.class, Toke_DalSegno.class, Toke_Fine.class, Toke_DaCapo.class, Toke_CondS.class];
        if (toker.sees(desires)) {
            this.phrases(noad);
            ^noad;
        };
