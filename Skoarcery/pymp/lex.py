# ========================================================================
# lex - Generated by Code_Py_Lexer on 2014-04-29 02:55:05 for Python 3.3.2
# ========================================================================
...
class Toke_ZedPlus(SkoarToke):
    regex = re.compile(r"[1-9][0-9]+(?![mv][ab])")
...
class Toke_Int(SkoarToke):
    regex = re.compile(r"(\+|-)?(0|[1-9][0-9]+)(?![mv][ab])")
...
class Toke_Choard(SkoarToke):
    regex = re.compile(r"(D(?!\.[CS]\.)|[ABCEFG])([Mm0-9]|sus|dim)*")
