// ==================================================================================================================================
// rdpp.sc.sc - Generated by Code_Parser_Sc - Create Recursive Descent Predictive Parser on 2014-05-11 10:30:37 for SuperCollider 3.6
// ==================================================================================================================================
...
SkoarParser {
    ...
    *new {
    ...
    meteroid {
        ...
        // meteroid -> clef
        desires = [Toke_AltoClef.class, Toke_BassClef.class, Toke_TrebleClef.class];
        if (toker.sees(desires)) {
    ...
    musical_keyword {
        ...
        desires = [Toke_QuindicesimaB.class, Toke_Loco.class, Toke_QuindicesimaA.class, Toke_OttavaA.class, Toke_OttavaB.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_Rep.class, Toke_DubRep.class, Toke_Portamento.class];
        if (toker.sees(desires)) {
    ...
    optional_stmt {
        ...
        // optional_stmt -> stmt
        desires = [Toke_VectorNoat.class, Toke_AccFlat.class, Toke_OttavaA.class, Toke_String.class, Toke_Slur.class,
                   Toke_Caesura.class, Toke_DynSFZ.class, Toke_OttavaB.class, Toke_Loco.class, Toke_Float.class,
                   Toke_Portamento.class, Toke_PedalUp.class, Toke_QuindicesimaB.class, Toke_Choard.class, Toke_QuindicesimaA.class,
                   Toke_Rep.class, Toke_DynPiano.class, Toke_AccNatural.class, Toke_DubRep.class, Toke_DynFP.class,
                   Toke_Carrots.class, Toke_ListS.class, Toke_PedalDown.class, Toke_Int.class, Toke_AccSharp.class,
                   Toke_Tuplet.class, Toke_CurNoat.class, Toke_LWing.class, Toke_DynForte.class, Toke_CondS.class,
                   Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    boolean {
        ...
        desires = [Toke_VectorNoat.class, Toke_AccFlat.class, Toke_OttavaA.class, Toke_Slur.class, Toke_String.class,
                   Toke_Caesura.class, Toke_DynSFZ.class, Toke_OttavaB.class, Toke_Loco.class, Toke_Float.class,
                   Toke_Portamento.class, Toke_PedalUp.class, Toke_QuindicesimaB.class, Toke_Choard.class, Toke_QuindicesimaA.class,
                   Toke_Rep.class, Toke_DynPiano.class, Toke_AccNatural.class, Toke_DubRep.class, Toke_DynFP.class,
                   Toke_ListS.class, Toke_PedalDown.class, Toke_Int.class, Toke_AccSharp.class, Toke_Tuplet.class,
                   Toke_CurNoat.class, Toke_LWing.class, Toke_DynForte.class, Toke_CondS.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    phrases {
        ...
        desires = [Toke_VectorNoat.class, Toke_Quarters.class, Toke_AccFlat.class, Toke_Quavers.class, Toke_String.class,
                   Toke_Slur.class, Toke_DynSFZ.class, Toke_Loco.class, Toke_Slash.class, Toke_Portamento.class,
                   Toke_PedalUp.class, Toke_Crotchets.class, Toke_QuindicesimaA.class, Toke_AccNatural.class, Toke_DubRep.class,
                   Toke_DynFP.class, Toke_ListS.class, Toke_Eighths.class, Toke_PedalDown.class, Toke_Int.class,
                   Toke_Coda.class, Toke_Tuplet.class, Toke_CurNoat.class, Toke_LWing.class, Toke_CondS.class,
                   Toke_Symbol.class, Toke_OttavaA.class, Toke_Caesura.class, Toke_OttavaB.class, Toke_Float.class,
                   Toke_MeterS.class, Toke_Volta.class, Toke_QuindicesimaB.class, Toke_Comment.class, Toke_Choard.class,
                   Toke_Rep.class, Toke_DynPiano.class, Toke_Fine.class, Toke_Segno.class, Toke_Bars.class,
                   Toke_AccSharp.class, Toke_DynForte.class, Toke_DaCapo.class, Toke_DalSegno.class];
        if (toker.sees(desires)) {
            this.phrasey(noad);
            this.phrases(noad);
            ^noad;
    ...
    phrasey {
        ...
        // phrasey -> marker
        desires = [Toke_Fine.class, Toke_Volta.class, Toke_Segno.class, Toke_Bars.class, Toke_Coda.class];
        if (toker.sees(desires)) {
    ...
    meter_stmt {
        ...
        // meter_stmt -> meteroid
        desires = [Toke_AltoClef.class, Toke_Carrots.class, Toke_TrebleClef.class, Toke_BassClef.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    meter_stmts {
        ...
        desires = [Toke_BassClef.class, Toke_TrebleClef.class, Toke_AltoClef.class, Toke_Carrots.class, Toke_Int.class,
                   Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    skoar {
        ...
        desires = [Toke_VectorNoat.class, Toke_Quarters.class, Toke_AccFlat.class, Toke_Quavers.class, Toke_String.class,
                   ...
                   Toke_PedalUp.class, Toke_Crotchets.class, Toke_QuindicesimaA.class, Toke_AccNatural.class, Toke_DubRep.class,
                   Toke_DynFP.class, Toke_ListS.class, Toke_Eighths.class, Toke_PedalDown.class, Toke_Int.class,
                   Toke_Coda.class, Toke_Tuplet.class, Toke_EOF.class, Toke_CurNoat.class, Toke_LWing.class,
                   Toke_CondS.class, Toke_Symbol.class, Toke_OttavaA.class, Toke_Caesura.class, Toke_OttavaB.class,
                   Toke_Float.class, Toke_MeterS.class, Toke_Volta.class, Toke_QuindicesimaB.class, Toke_Comment.class,
                   Toke_Choard.class, Toke_Rep.class, Toke_DynPiano.class, Toke_Fine.class, Toke_Segno.class,
                   Toke_Bars.class, Toke_AccSharp.class, Toke_DynForte.class, Toke_DaCapo.class, Toke_DalSegno.class];
        if (toker.sees(desires)) {
            this.phrases(noad);
            ^noad;
        };
    ...
    nouny {
        ...
        // nouny -> noaty
        desires = [Toke_VectorNoat.class, Toke_CurNoat.class, Toke_ListS.class, Toke_Choard.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.noaty(noad));
            ^noad;
        };
        ...
        // nouny -> nouny_literal
        desires = [Toke_Int.class, Toke_Float.class, Toke_Tuplet.class, Toke_Caesura.class, Toke_Slur.class,
                   Toke_String.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_DynPiano.class, Toke_DubRep.class, Toke_DynFP.class, Toke_OttavaA.class, Toke_PedalDown.class,
                   Toke_OttavaB.class, Toke_DynSFZ.class, Toke_Loco.class, Toke_Portamento.class, Toke_PedalUp.class,
                   Toke_DynForte.class, Toke_QuindicesimaB.class, Toke_QuindicesimaA.class, Toke_Rep.class];
        if (toker.sees(desires)) {
