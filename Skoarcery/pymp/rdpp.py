# ==================================================================================================================
# rdpp.py - Generated by PyRDPP - Create Recursive Descent Predictive Parser on 2014-04-29 05:12:39 for Python 3.3.2
# ==================================================================================================================
from Skoarcery.pymp.lex import Toke_ListSep, Toke_DynForte, Toke_LWing, Toke_OttavaA, Toke_RWing, \
    Toke_OttavaB, Toke_Fine, Toke_Quavers, Toke_MsgName, Toke_Int, \
    Toke_Quarters, Toke_DynSFZ, Toke_BassClef, Toke_DaCapo, Toke_Bars, \
    Toke_DynPiano, Toke_Coda, Toke_AlCoda, Toke_Eighths, Toke_TrebleClef, \
    Toke_Crotchets, Toke_ListE, Toke_PedalUp, Toke_QuindicesimaB, Toke_QuindicesimaA, \
    Toke_Slash, Toke_MeterS, Toke_Carrots, Toke_DynFP, Toke_Slur, \
    Toke_MsgOp, Toke_ListS, Toke_Rep, Toke_NoatSharps, Toke_MeterE, \
    Toke_VectorNoat, Toke_BooleanOp, Toke_Volta, Toke_PedalDown, Toke_AccNatural, \
    Toke_CondSep, Toke_NoatFlats, Toke_AccFlat, Toke_Tuplet, Toke_Float, \
    Toke_Loco, Toke_DubRep, Toke_Comment, Toke_AlFine, Toke_EOF, \
    Toke_AccSharp, Toke_Symbol, Toke_WS, Toke_AltoClef, Toke_DalSegno, \
    Toke_CondE, Toke_Choard, Toke_AlSegno, Toke_Portamento, Toke_MsgNameWithArgs, \
    Toke_Segno, Toke_Caesura, Toke_CurNoat, Toke_Nosey, Toke_AssOp, \
...
class SkoarParser:
    ...
    def meter_ass_r(self):
        ...
        # meter_ass_r -> beat
        desires = [Toke_Crotchets, Toke_Quarters, Toke_Slash, Toke_Eighths, Toke_Quavers]
        if self.toker.sees(desires):
        ...
        # meter_ass_r -> dynamic
        desires = [Toke_DynForte, Toke_DynFP, Toke_DynPiano, Toke_DynSFZ]
        if self.toker.sees(desires):
    ...
    def musical_keyword(self):
        ...
        desires = [Toke_QuindicesimaB, Toke_OttavaA, Toke_OttavaB, Toke_Loco, Toke_QuindicesimaA]
        if self.toker.sees(desires):
        ...
        desires = [Toke_Portamento, Toke_Rep, Toke_PedalDown, Toke_DubRep, Toke_PedalUp]
        if self.toker.sees(desires):
    ...
    def listy_suffix(self):
        ...
        desires = [Toke_DynForte, Toke_PedalDown, Toke_LWing, Toke_AccNatural, Toke_OttavaA,
                   Toke_OttavaB, Toke_AccFlat, Toke_Tuplet, Toke_Float, Toke_Symbol,
                   Toke_Int, Toke_DynSFZ, Toke_Loco, Toke_DubRep, Toke_DynPiano,
                   Toke_AccSharp, Toke_PedalUp, Toke_Rep, Toke_QuindicesimaB, Toke_QuindicesimaA,
                   Toke_Choard, Toke_Portamento, Toke_DynFP, Toke_Slur, Toke_ListS,
                   Toke_Caesura, Toke_CurNoat, Toke_VectorNoat, Toke_CondS, Toke_String]
        if self.toker.sees(desires):
    ...
    def phrases(self):
        ...
        desires = [Toke_DalSegno, Toke_DynForte, Toke_LWing, Toke_OttavaA, Toke_OttavaB,
                   Toke_Quavers, Toke_Int, Toke_Quarters, Toke_DynSFZ, Toke_DaCapo,
                   Toke_Bars, Toke_DynPiano, Toke_Coda, Toke_Eighths, Toke_Crotchets,
                   Toke_PedalUp, Toke_QuindicesimaB, Toke_QuindicesimaA, Toke_Slash, Toke_MeterS,
                   Toke_DynFP, Toke_Slur, Toke_ListS, Toke_VectorNoat, Toke_PedalDown,
                   Toke_AccNatural, Toke_AccFlat, Toke_Tuplet, Toke_Float, Toke_Loco,
                   Toke_DubRep, Toke_Comment, Toke_AccSharp, Toke_Symbol, Toke_Rep,
                   Toke_Fine, Toke_Choard, Toke_Portamento, Toke_Segno, Toke_Caesura,
                   Toke_CurNoat, Toke_CondS, Toke_String]
        if self.toker.sees(desires):
    ...
    def meter_stmts(self):
        ...
        desires = [Toke_Carrots, Toke_Symbol, Toke_Int, Toke_BassClef, Toke_AltoClef,
                   Toke_TrebleClef]
        if self.toker.sees(desires):
    ...
    def meter_stmt(self):
        ...
        # meter_stmt -> meteroid
        desires = [Toke_Carrots, Toke_Symbol, Toke_AltoClef, Toke_BassClef, Toke_TrebleClef]
        if self.toker.sees(desires):
    ...
    def optional_stmt(self):
        # optional_stmt -> stmt
        desires = [Toke_DynForte, Toke_PedalDown, Toke_LWing, Toke_AccNatural, Toke_OttavaA,
                   Toke_OttavaB, Toke_AccFlat, Toke_PedalUp, Toke_Float, Toke_Symbol,
                   Toke_Int, Toke_DynSFZ, Toke_Loco, Toke_DubRep, Toke_Choard,
                   Toke_DynPiano, Toke_Portamento, Toke_AccSharp, Toke_Rep, Toke_QuindicesimaB,
                   Toke_QuindicesimaA, Toke_Tuplet, Toke_Carrots, Toke_DynFP, Toke_Slur,
                   Toke_ListS, Toke_Caesura, Toke_CurNoat, Toke_VectorNoat, Toke_CondS,
                   Toke_String]
        if self.toker.sees(desires):
    ...
    def skoaroid(self):
        ...
        desires = [Toke_DynForte, Toke_PedalDown, Toke_LWing, Toke_AccNatural, Toke_OttavaA,
                   Toke_OttavaB, Toke_AccFlat, Toke_PedalUp, Toke_Float, Toke_Symbol,
                   Toke_Int, Toke_DynSFZ, Toke_Loco, Toke_DubRep, Toke_Choard,
                   Toke_DynPiano, Toke_AccSharp, Toke_Rep, Toke_QuindicesimaB, Toke_QuindicesimaA,
                   Toke_Tuplet, Toke_Portamento, Toke_DynFP, Toke_Slur, Toke_ListS,
                   Toke_Caesura, Toke_CurNoat, Toke_VectorNoat, Toke_CondS, Toke_String]
        if self.toker.sees(desires):
    ...
    def nouny(self):
        ...
        # nouny -> noaty
        desires = [Toke_Symbol, Toke_ListS, Toke_CurNoat, Toke_VectorNoat, Toke_CondS,
                   Toke_Choard]
        if self.toker.sees(desires):
        ...
        # nouny -> nouny_literal
        desires = [Toke_Float, Toke_Slur, Toke_Int, Toke_Caesura, Toke_String,
                   Toke_Tuplet]
        if self.toker.sees(desires):
        ...
        desires = [Toke_DynForte, Toke_PedalDown, Toke_QuindicesimaA, Toke_Rep, Toke_QuindicesimaB,
                   Toke_OttavaA, Toke_OttavaB, Toke_PedalUp, Toke_Portamento, Toke_DynFP,
                   Toke_DynSFZ, Toke_Loco, Toke_DubRep, Toke_DynPiano]
        if self.toker.sees(desires):
    ...
    def skoar(self):
        # skoar -> phrases
        desires = [Toke_DynForte, Toke_DalSegno, Toke_LWing, Toke_OttavaA, Toke_OttavaB,
                   Toke_Quavers, Toke_Int, Toke_Quarters, Toke_DynSFZ, Toke_DaCapo,
                   Toke_Bars, Toke_DynPiano, Toke_Coda, Toke_Eighths, Toke_Crotchets,
                   Toke_Comment, Toke_QuindicesimaB, Toke_QuindicesimaA, Toke_Slash, Toke_MeterS,
                   Toke_DynFP, Toke_Slur, Toke_Rep, Toke_ListS, Toke_VectorNoat,
                   Toke_PedalDown, Toke_AccNatural, Toke_AccFlat, Toke_PedalUp, Toke_Float,
                   Toke_Loco, Toke_DubRep, Toke_Tuplet, Toke_EOF, Toke_AccSharp,
                   Toke_Symbol, Toke_Fine, Toke_Choard, Toke_Portamento, Toke_Segno,
                   Toke_Caesura, Toke_CurNoat, Toke_CondS, Toke_String]
        if self.toker.sees(desires):
