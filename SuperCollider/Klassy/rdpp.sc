// ==================================================================================================================================
// rdpp.sc.sc - Generated by Code_Parser_Sc - Create Recursive Descent Predictive Parser on 2014-05-10 23:20:29 for SuperCollider 3.6
// ==================================================================================================================================
...
SkoarParser {
    ...
    *new {
    ...
    skoar {
        ...
        // skoar -> phrases
        desires = [Toke_Caesura.class, Toke_DynFP.class, Toke_DalSegno.class, Toke_QuindicesimaA.class, Toke_DynPiano.class,
                   Toke_Quarters.class, Toke_Int.class, Toke_DynSFZ.class, Toke_Rep.class, Toke_Volta.class,
                   Toke_PedalUp.class, Toke_Crotchets.class, Toke_Fine.class, Toke_Portamento.class, Toke_Slash.class,
                   Toke_Quavers.class, Toke_AccSharp.class, Toke_Coda.class, Toke_PedalDown.class, Toke_DynForte.class,
                   Toke_OttavaA.class, Toke_Eighths.class, Toke_EOF.class, Toke_MeterS.class, Toke_Float.class,
                   Toke_Symbol.class, Toke_Loco.class, Toke_DaCapo.class, Toke_String.class, Toke_Comment.class,
                   Toke_Bars.class, Toke_QuindicesimaB.class, Toke_Slur.class, Toke_DubRep.class, Toke_AccFlat.class,
                   Toke_AccNatural.class, Toke_ListS.class, Toke_Segno.class, Toke_Tuplet.class, Toke_CurNoat.class,
                   Toke_Choard.class, Toke_VectorNoat.class, Toke_OttavaB.class, Toke_LWing.class, Toke_CondS.class];
        if (toker.sees(desires)) {
            this.phrases(noad);
            ^noad;
        };
    ...
    listy_entries {
        ...
        desires = [Toke_Caesura.class, Toke_DynFP.class, Toke_DynForte.class, Toke_OttavaA.class, Toke_QuindicesimaA.class,
                   Toke_DynPiano.class, Toke_Float.class, Toke_Symbol.class, Toke_Loco.class, Toke_Int.class,
                   Toke_String.class, Toke_DynSFZ.class, Toke_Rep.class, Toke_QuindicesimaB.class, Toke_PedalUp.class,
                   Toke_Slur.class, Toke_DubRep.class, Toke_AccFlat.class, Toke_ListS.class, Toke_AccNatural.class,
                   Toke_Portamento.class, Toke_Tuplet.class, Toke_CurNoat.class, Toke_Choard.class, Toke_AccSharp.class,
                   Toke_VectorNoat.class, Toke_OttavaB.class, Toke_LWing.class, Toke_PedalDown.class, Toke_CondS.class];
        if (toker.sees(desires)) {
    ...
    phrases {
        ...
        desires = [Toke_Caesura.class, Toke_DynFP.class, Toke_DalSegno.class, Toke_QuindicesimaA.class, Toke_DynPiano.class,
                   ...
                   Toke_PedalUp.class, Toke_Crotchets.class, Toke_Fine.class, Toke_Portamento.class, Toke_Slash.class,
                   Toke_Quavers.class, Toke_AccSharp.class, Toke_Coda.class, Toke_PedalDown.class, Toke_DynForte.class,
                   Toke_OttavaA.class, Toke_Eighths.class, Toke_MeterS.class, Toke_Float.class, Toke_Symbol.class,
                   Toke_Loco.class, Toke_DaCapo.class, Toke_String.class, Toke_Comment.class, Toke_Bars.class,
                   Toke_QuindicesimaB.class, Toke_Slur.class, Toke_DubRep.class, Toke_AccFlat.class, Toke_ListS.class,
                   Toke_AccNatural.class, Toke_Segno.class, Toke_Tuplet.class, Toke_CurNoat.class, Toke_Choard.class,
                   Toke_VectorNoat.class, Toke_OttavaB.class, Toke_LWing.class, Toke_CondS.class];
        if (toker.sees(desires)) {
            this.phrasey(noad);
            this.phrases(noad);
            ^noad;
    ...
    meter_ass_r {
        ...
        desires = [Toke_Crotchets.class, Toke_Eighths.class, Toke_Quarters.class, Toke_Slash.class, Toke_Quavers.class];
        if (toker.sees(desires)) {
        ...
        // meter_ass_r -> dynamic
        desires = [Toke_DynPiano.class, Toke_DynSFZ.class, Toke_DynFP.class, Toke_DynForte.class];
        if (toker.sees(desires)) {
    ...
    nouny {
        ...
        // nouny -> noaty
        desires = [Toke_ListS.class, Toke_VectorNoat.class, Toke_Symbol.class, Toke_CurNoat.class, Toke_Choard.class];
        if (toker.sees(desires)) {
        ...
        // nouny -> nouny_literal
        desires = [Toke_Caesura.class, Toke_Tuplet.class, Toke_Float.class, Toke_Slur.class, Toke_Int.class,
                   Toke_String.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_DynSFZ.class, Toke_DynFP.class, Toke_DynForte.class, Toke_Rep.class, Toke_QuindicesimaB.class,
                   Toke_OttavaA.class, Toke_QuindicesimaA.class, Toke_PedalUp.class, Toke_DubRep.class, Toke_DynPiano.class,
                   Toke_Portamento.class, Toke_Loco.class, Toke_OttavaB.class, Toke_PedalDown.class];
        if (toker.sees(desires)) {
    ...
    meteroid {
        ...
        // meteroid -> clef
        desires = [Toke_BassClef.class, Toke_AltoClef.class, Toke_TrebleClef.class];
        if (toker.sees(desires)) {
    ...
    stmt {
        ...
        desires = [Toke_Caesura.class, Toke_DynFP.class, Toke_DynForte.class, Toke_OttavaA.class, Toke_QuindicesimaA.class,
                   ...
                   Toke_Slur.class, Toke_DubRep.class, Toke_AccFlat.class, Toke_ListS.class, Toke_AccNatural.class,
                   Toke_Portamento.class, Toke_Tuplet.class, Toke_CurNoat.class, Toke_Choard.class, Toke_AccSharp.class,
                   Toke_VectorNoat.class, Toke_OttavaB.class, Toke_LWing.class, Toke_Carrots.class, Toke_PedalDown.class,
                   Toke_CondS.class];
        if (toker.sees(desires)) {
            noad.add_noad(this.optional_carrots(noad));
            noad.add_noad(this.skoaroid(noad));
    ...
    meter_stmt {
        ...
        // meter_stmt -> meteroid
        desires = [Toke_TrebleClef.class, Toke_BassClef.class, Toke_AltoClef.class, Toke_Carrots.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    meter_stmts {
        ...
        desires = [Toke_TrebleClef.class, Toke_Symbol.class, Toke_BassClef.class, Toke_Int.class, Toke_AltoClef.class,
                   Toke_Carrots.class];
        if (toker.sees(desires)) {
    ...
    musical_keyword {
        ...
        desires = [Toke_QuindicesimaB.class, Toke_OttavaB.class, Toke_OttavaA.class, Toke_QuindicesimaA.class, Toke_Loco.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_Portamento.class, Toke_DubRep.class, Toke_Rep.class];
        if (toker.sees(desires)) {
    ...
    noaty {
        ...
        // noaty -> noat_literal
        desires = [Toke_VectorNoat.class, Toke_Choard.class];
        if (toker.sees(desires)) {
        ...
        desires = [Toke_ListS.class, Toke_CurNoat.class, Toke_Symbol.class];
        if (toker.sees(desires)) {
    ...
    phrasey {
        ...
        // phrasey -> marker
        desires = [Toke_Segno.class, Toke_Fine.class, Toke_Volta.class, Toke_Coda.class, Toke_Bars.class];
        if (toker.sees(desires)) {
