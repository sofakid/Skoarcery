# ===========================================================================
# lex.py - Generated by Code_Py_Lexer on 2015-09-21 17:03:36 for Python 3.3.2
# ===========================================================================
...
class Toke_CutsE(SkoarToke):
    regex = re.compile(r"=[}]")

    @staticmethod
    def match(buf, offs):
        return SkoarToke.match_toke(buf, offs, Toke_CutsE)
...
class Toke_Cat(SkoarToke):
    regex = re.compile(r"=\^\.\^=")

    @staticmethod
    def match(buf, offs):
        return SkoarToke.match_toke(buf, offs, Toke_Cat)
...
class Toke_CutsS(SkoarToke):
    regex = re.compile(r"[{]=[\n]*")

    @staticmethod
    def match(buf, offs):
        return SkoarToke.match_toke(buf, offs, Toke_CutsS)
...
class Toke_Choard(SkoarToke):
    regex = re.compile(r"[ABCDEFG](?![.ce-ln-rt-zA-LN-Z]|al?)(#|b)?([Mm0-9]|sus|dim|aug|dom|add)*")
