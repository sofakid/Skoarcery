# ==================================================================================================================
# rdpp.py - Generated by PyRDPP - Create Recursive Descent Predictive Parser on 2015-04-05 23:30:19 for Python 3.3.2
# ==================================================================================================================
from Skoarcery.SkoarPyon.apparatus import SkoarNoad
from Skoarcery.SkoarPyon.lex import Toke_Rep, Toke_DynSFZ, Toke_Deref, Toke_OctaveShift, Toke_OttavaB, \
    Toke_Choard, Toke_Whitespace, Toke_Meter, Toke_Portamento, Toke_Times, \
    Toke_AlFine, Toke_Coda, Toke_Fine, Toke_DynFP, Toke_SkoarpionSep, \
    Toke_SymbolName, Toke_Eighths, Toke_DynForte, Toke_MathOp, Toke_Bars, \
    Toke_Fairy, Toke_SkoarpionEnd, Toke_Segno, Toke_CondE, Toke_Tuplet, \
    Toke_Voice, Toke_MsgName, Toke_ListE, Toke_DalSegno, Toke_Loco, \
    Toke_EOF, Toke_Carrot, Toke_LoopS, Toke_PedalUp, Toke_Slash, \
    Toke_Newline, Toke_ListS, Toke_AssOp, Toke_Symbol, Toke_LoopSep, \
    Toke_DaCapo, Toke_Quavers, Toke_ListSep, Toke_LWing, Toke_SkoarpionStart, \
    Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_AlCoda, Toke_QuindicesimaB, \
    Toke_NamedNoat, Toke_RWing, Toke_BooleanOp, Toke_Quarters, Toke_Freq, \
    Toke_QuindicesimaA, Toke_Volta, Toke_Comment, Toke_Nosey, Toke_DynPiano, \
    Toke_LoopE, Toke_CondIf, Toke_Semicolon, Toke_OttavaA, Toke_MsgNameWithArgs, \
    Toke_Int, Toke_AlSegno, Toke_CondS, Toke_Crotchets, Toke_String, \
    Toke_MsgOp
...
class SkoarParser:
    ...
    def init_desirables(self):
        ...
        # if_body
        self.desirables['if_body -> phrases'] = [Toke_DynSFZ, Toke_Deref, Toke_Volta, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_PedalUp, Toke_DynForte, Toke_Eighths, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_CondE, Toke_DalSegno, Toke_Comment, Toke_Carrot,
                   Toke_Loco, Toke_OttavaA, Toke_Slash, Toke_Newline, Toke_ListS,
                   Toke_Portamento, Toke_DaCapo, Toke_Quavers, Toke_LoopS, Toke_LWing,
                   Toke_SkoarpionStart, Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_Quarters, Toke_OctaveShift,
                   Toke_QuindicesimaA, Toke_Freq, Toke_DynPiano, Toke_CondIf, Toke_Tuplet,
                   Toke_Int, Toke_CondS, Toke_Crotchets]
        ...
        # msgable
        self.desirables['msgable -> nouny msg_chain_node'] = [Toke_ListS, Toke_DynSFZ, Toke_Portamento, Toke_Deref, Toke_OttavaB,
                   Toke_Choard, Toke_Symbol, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart,
                   Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep, Toke_DynFP,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_PedalUp, Toke_DynForte,
                   Toke_OctaveShift, Toke_Freq, Toke_QuindicesimaA, Toke_Fairy, Toke_DynPiano,
                   Toke_Tuplet, Toke_Carrot, Toke_Loco, Toke_Int, Toke_CondS,
                   Toke_OttavaA]
        ...
        # loop_body
        self.desirables['loop_body -> phrases'] = [Toke_DynSFZ, Toke_Deref, Toke_Volta, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_PedalUp, Toke_DynForte, Toke_Eighths, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_DalSegno, Toke_Comment, Toke_Carrot, Toke_Loco,
                   Toke_OttavaA, Toke_Slash, Toke_ListS, Toke_Portamento, Toke_LoopSep,
                   Toke_DaCapo, Toke_Quavers, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart,
                   Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep, Toke_QuindicesimaB,
                   Toke_NamedNoat, Toke_String, Toke_Quarters, Toke_OctaveShift, Toke_QuindicesimaA,
                   Toke_Freq, Toke_DynPiano, Toke_LoopE, Toke_Tuplet, Toke_Int,
                   Toke_CondS, Toke_Crotchets]

        # branches
        self.desirables['branches -> branch branches'] = [Toke_DynSFZ, Toke_Deref, Toke_Volta, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_PedalUp, Toke_DynForte, Toke_Eighths, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_Voice, Toke_DalSegno, Toke_Comment, Toke_Carrot,
                   Toke_Loco, Toke_OttavaA, Toke_Slash, Toke_Newline, Toke_ListS,
                   Toke_Portamento, Toke_DaCapo, Toke_Quavers, Toke_LoopS, Toke_LWing,
                   Toke_SkoarpionStart, Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_Quarters, Toke_OctaveShift,
                   Toke_QuindicesimaA, Toke_Freq, Toke_DynPiano, Toke_Tuplet, Toke_Int,
                   Toke_CondS, Toke_Crotchets]
        ...
        self.desirables['phrasey -> marker'] = [Toke_Coda, Toke_Fine, Toke_Segno, Toke_Volta, Toke_Bars]
        self.desirables['phrasey -> Meter'] = [Toke_Meter]
        self.desirables['phrasey -> expr'] = [Toke_ListS, Toke_DynSFZ, Toke_Portamento, Toke_Deref, Toke_OttavaB,
                   Toke_Choard, Toke_Symbol, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart,
                   Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep, Toke_DynFP,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_PedalUp, Toke_DynForte,
                   Toke_OctaveShift, Toke_Freq, Toke_QuindicesimaA, Toke_Fairy, Toke_DynPiano,
        ...
        self.desirables['phrasey -> beat'] = [Toke_Eighths, Toke_Quarters, Toke_Crotchets, Toke_Slash, Toke_Quavers]
        ...
        # skoar
        self.desirables['skoar -> branches'] = [Toke_DynSFZ, Toke_Deref, Toke_Volta, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_PedalUp, Toke_DynForte, Toke_Eighths, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_Voice, Toke_DalSegno, Toke_Comment, Toke_EOF,
                   Toke_Carrot, Toke_Loco, Toke_OttavaA, Toke_Slash, Toke_Newline,
                   Toke_ListS, Toke_Portamento, Toke_DaCapo, Toke_Quavers, Toke_LoopS,
                   Toke_LWing, Toke_SkoarpionStart, Toke_PedalDown, Toke_Caesura, Toke_Float,
                   Toke_Rep, Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_Quarters,
                   Toke_OctaveShift, Toke_QuindicesimaA, Toke_Freq, Toke_DynPiano, Toke_Tuplet,
                   Toke_Int, Toke_CondS, Toke_Crotchets]

        # skrp_suffix
        self.desirables['skrp_suffix -> skrp_lines SkoarpionEnd'] = [Toke_DynSFZ, Toke_Deref, Toke_Volta, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_PedalUp, Toke_DynForte, Toke_Eighths, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_Voice, Toke_DalSegno, Toke_Comment, Toke_Carrot,
                   Toke_Loco, Toke_OttavaA, Toke_Slash, Toke_Newline, Toke_ListS,
                   ...
                   Toke_SkoarpionStart, Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_Quarters, Toke_OctaveShift,
                   Toke_QuindicesimaA, Toke_Freq, Toke_SkoarpionEnd, Toke_DynPiano, Toke_Tuplet,
                   Toke_Int, Toke_CondS, Toke_Crotchets]
        ...
        self.desirables['nouny -> nouny_literal'] = [Toke_Fairy, Toke_Choard, Toke_Symbol, Toke_Tuplet, Toke_Caesura,
                   Toke_Float, Toke_Int, Toke_NamedNoat, Toke_String, Toke_Freq]
        self.desirables['nouny -> musical_keyword'] = [Toke_DynSFZ, Toke_Portamento, Toke_DynPiano, Toke_OttavaB, Toke_PedalDown,
                   Toke_Rep, Toke_DynFP, Toke_QuindicesimaB, Toke_Carrot, Toke_Loco,
                   Toke_PedalUp, Toke_DynForte, Toke_OctaveShift, Toke_QuindicesimaA, Toke_OttavaA]
        ...
        # cond_if
        self.desirables['cond_if -> optional_voice expr CondIf if_body cond_else'] = [Toke_DynSFZ, Toke_Deref, Toke_OttavaB, Toke_Choard, Toke_Symbol,
                   Toke_DynFP, Toke_PedalUp, Toke_DynForte, Toke_Fairy, Toke_Voice,
                   Toke_Carrot, Toke_Loco, Toke_OttavaA, Toke_ListS, Toke_Portamento,
                   Toke_LoopS, Toke_LWing, Toke_SkoarpionStart, Toke_PedalDown, Toke_Caesura,
                   Toke_Float, Toke_Rep, Toke_QuindicesimaB, Toke_NamedNoat, Toke_String,
                   Toke_OctaveShift, Toke_Freq, Toke_QuindicesimaA, Toke_DynPiano, Toke_Tuplet,
                   Toke_Int, Toke_CondS]

        # expr
        self.desirables['expr -> msgable expr_prime'] = [Toke_ListS, Toke_DynSFZ, Toke_Portamento, Toke_Deref, Toke_OttavaB,
                   Toke_Choard, Toke_Symbol, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart,
                   Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep, Toke_DynFP,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_PedalUp, Toke_DynForte,
                   Toke_OctaveShift, Toke_Freq, Toke_QuindicesimaA, Toke_Fairy, Toke_DynPiano,
        ...
        # branch
        self.desirables['branch -> optional_voice phrases Newline'] = [Toke_DynSFZ, Toke_Deref, Toke_Volta, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_PedalUp, Toke_DynForte, Toke_Eighths, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_Voice, Toke_DalSegno, Toke_Comment, Toke_Carrot,
                   Toke_Loco, Toke_OttavaA, Toke_Slash, Toke_Newline, Toke_ListS,
        ...
        # cond_ifs
        self.desirables['cond_ifs -> cond_if cond_ifs_suffix'] = [Toke_DynSFZ, Toke_Deref, Toke_OttavaB, Toke_Choard, Toke_Symbol,
                   Toke_DynFP, Toke_PedalUp, Toke_DynForte, Toke_Fairy, Toke_Voice,
                   Toke_Carrot, Toke_Loco, Toke_OttavaA, Toke_ListS, Toke_Portamento,
                   Toke_LoopS, Toke_LWing, Toke_SkoarpionStart, Toke_PedalDown, Toke_Caesura,
                   Toke_Float, Toke_Rep, Toke_QuindicesimaB, Toke_NamedNoat, Toke_String,
        ...
        self.desirables['musical_keyword -> ottavas'] = [Toke_QuindicesimaB, Toke_Loco, Toke_OttavaB, Toke_OctaveShift, Toke_QuindicesimaA,
                   Toke_OttavaA]
        ...
        # phrases
        self.desirables['phrases -> phrasey phrases'] = [Toke_DynSFZ, Toke_Volta, Toke_Deref, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_Eighths, Toke_PedalUp, Toke_DynForte, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_DalSegno, Toke_Comment, Toke_Carrot, Toke_Loco,
                   Toke_Slash, Toke_OttavaA, Toke_ListS, Toke_Portamento, Toke_DaCapo,
                   Toke_Quavers, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart, Toke_PedalDown,
                   Toke_Caesura, Toke_Float, Toke_Rep, Toke_QuindicesimaB, Toke_NamedNoat,
                   Toke_String, Toke_Quarters, Toke_Freq, Toke_OctaveShift, Toke_QuindicesimaA,
                   Toke_DynPiano, Toke_Tuplet, Toke_Int, Toke_CondS, Toke_Crotchets]
        ...
        # cthulhu_prime
        self.desirables['cthulhu_prime -> expr Semicolon RWing'] = [Toke_ListS, Toke_DynSFZ, Toke_Portamento, Toke_Deref, Toke_OttavaB,
                   Toke_Choard, Toke_Symbol, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart,
                   Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep, Toke_DynFP,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_PedalUp, Toke_DynForte,
                   Toke_OctaveShift, Toke_Freq, Toke_QuindicesimaA, Toke_Fairy, Toke_DynPiano,
        ...
        # listy_suffix
        self.desirables['listy_suffix -> listy_entries ListE'] = [Toke_ListS, Toke_DynSFZ, Toke_Portamento, Toke_Deref, Toke_OttavaB,
                   Toke_Choard, Toke_Symbol, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart,
                   Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep, Toke_DynFP,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_PedalUp, Toke_DynForte,
                   Toke_OctaveShift, Toke_Freq, Toke_QuindicesimaA, Toke_Fairy, Toke_DynPiano,
        ...
        # listy_entries
        self.desirables['listy_entries -> expr moar_listy_entries'] = [Toke_ListS, Toke_DynSFZ, Toke_Portamento, Toke_Deref, Toke_OttavaB,
                   Toke_Choard, Toke_Symbol, Toke_LoopS, Toke_LWing, Toke_SkoarpionStart,
                   Toke_PedalDown, Toke_Caesura, Toke_Float, Toke_Rep, Toke_DynFP,
                   Toke_QuindicesimaB, Toke_NamedNoat, Toke_String, Toke_PedalUp, Toke_DynForte,
                   Toke_OctaveShift, Toke_Freq, Toke_QuindicesimaA, Toke_Fairy, Toke_DynPiano,
        ...
        # skrp_lines
        self.desirables['skrp_lines -> optional_voice phrases skrp_moar_lines'] = [Toke_DynSFZ, Toke_Deref, Toke_Volta, Toke_OttavaB, Toke_Choard,
                   Toke_Symbol, Toke_Meter, Toke_Coda, Toke_Fine, Toke_DynFP,
                   Toke_PedalUp, Toke_DynForte, Toke_Eighths, Toke_Bars, Toke_Fairy,
                   Toke_Segno, Toke_Voice, Toke_DalSegno, Toke_Comment, Toke_Carrot,
                   Toke_Loco, Toke_OttavaA, Toke_Slash, Toke_Newline, Toke_ListS,
