// ================================================================================
// lex.sc - Generated by Code_Sc_Lexer on 2015-12-13 19:43:37 for SuperCollider 3.7
// ================================================================================
// --------------
// SkoarException
// --------------
...
Toke_Choard : SkoarToke {
    classvar <regex = "~*[ABCDEFG](?![.ce-ln-rt-zA-LN-Z]|a[l ])(#|b)?([Mm0-9]|sus|dim|aug|dom)*(/[A-G][#b]?)?~*";
...
Toke_UGen : SkoarToke {
    classvar <regex = "u[A-Z][A-Za-z0-9_]*";

    *match {
        | buf, offs |

        ^SkoarToke.match_toke(buf, offs, Toke_UGen);
    }
